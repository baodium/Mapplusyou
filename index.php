...
if ($client->getAccessToken()) {
  ...
  $name=explode(" ",$name2);
  $name=$name[0];
  $personMarkup = "<a rel='me' href='$url' id='menu-list-a' style='color:#006699; height:3px ' ><img src='$img' style='border-radius:50%; width:32px; height:32px; margin-bottom:-10px'  >&nbsp;$name</a>";//would be used to identify logged in user
...
<div id="top" data-magellan-expedition="fixed" style="position: fixed; top: 0px; height:90px ">
		...
		<div class="large-12 columns" style="background:transparent">
			<nav class="top-bar" style="background:transparent">
			  <ul class="title-area" style="background:transparent; " id="<?php if($page=='contract.php' || $page=="location.php" || $page=="opportunityalert.php" || $page=="current.php" || $page=="myopportunities.php"){ ?>lfloat<?php } ?>">
			   <li class="logo" style="padding-top:10px; background:transparent">
			      <a href="" id="log_up" ><img src="resources/images/logo3.png" style="width:50px; height:50px; margin-bottom:-15px; ">applusyou</a>			    </li>
		  ...
		  <section class="top-bar-section" style="left: 0%; background:transparent" >
				...
				<li <?php echo ($page=='home.php' || $page=="")?'class="active"':'' ?>  ><a href="?p=home.php" style="color: #006699;" id="menu-list-a" onClick="loadUrl('home.php');">Home</a></li>
							<li <?php echo ($page=='contract.php' || $page=='new.php'||  $page=='enablesms.php' ||  $page=='myopportunities.php' ||  $page=='edit.php' || $page=='applicants.php' || $page=='searchresult.php' || $page=='job_detail.php' || $page=='myopportunities.php' || $page=='apply.php' || $page=='create_cv.php')?'class="active"':'' ?>><a href="?p=contract.php" style="color: #006699; " id="menu-list-a" onClick="loadUrl('contract.php');" >Opportunities</a></li> 
                            <li <?php echo ($page=='location.php' || $page=='current.php'  || $page=='new_activity.php' || $page=='watchvideo.php')?'class="active"':'' ?>><a href="?p=location.php" style="color: #006699; " id="menu-list-a" onClick="loadUrl('location.php');">Activities</a></li>
                            ...
                            <li style="font-size:12px; border-top:0px"><?php if(isset($_SESSION['mapplusu_user'])){ echo ''. $_SESSION['mapplusu_user'].'';   ?></li>
                                  <?php   echo '<li style="height:0px; background:transparent" id="in-log" ><div class="click-nav">
  <ul class="no-jss">
    <li>
      <a href="#" id="menu-list-a" class="clicker"></a>
      <ul>
        <li><a href="?p=logout.php" style="background:transparent; font-size:13px" id="menu-list-a" >&nbspSign out</a></li>
      </ul>
    </li>
  </ul>
</div></li> <li id="log-remove"><a href="?p=logout.php" style="background:transparent" id="menu-list-a" >Sign out&nbsp;<img src="resources/images/i-6.png" alt="Icon"></a></li>           
			'; }else{?>
...
<footer style="background:#000000">
	<div class="row2">
		...
		<div class="large-8 columns">
			<ul class="inline-list" style="">
			  <li class="copyright" style="color:#FFFFFF"><ul><li>ABOUT</li><li><a href="?p=about.php#about" style="color:#999">About Mapplusyou</a></li></ul></li><li><ul><li style="color:#FFFFFF">PRIVACY</li><li><a href="?p=about.php#privacy" style="color:#999">Terms & Conditions</a></li></ul></li><li><ul><li style="color:#FFFFFF">CONTACT</li><li><a href="mailto:mapplusyou@gmail.com" style="color:#999">mapplusyou@gmail.com</a></li></ul></li>
  			</ul>
		</div>
	...
	<script>
$(function () {
  $('.click-nav > ul').toggleClass('no-jss js');
  $('.click-nav .jss ul').hide();
  $('.click-nav .jss').click(function(e) {
    $('.click-nav .jss ul').slideToggle(200);
    $('.clicker').toggleClass('active');
    e.stopPropagation();
  });
  $(document).click(function() {
    if ($('.click-nav .jss ul').is(':visible')) {
      $('.click-nav .jss ul', this).slideUp();
